...
class past_trip_adapter(private val context: Context, private val navController: NavController, private val userList: List<TripsModel>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PastTripViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.trips_layout, parent, false)
        return PastTripViewHolder(itemView)
    }

    override fun onBindViewHolder(holder: PastTripViewHolder, position: Int) {
