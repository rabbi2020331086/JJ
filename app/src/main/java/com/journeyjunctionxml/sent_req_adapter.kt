...
class sent_req_adapter(navController: NavController,private val userList: List<search_users_model>) :
    RecyclerView.Adapter<sent_req_adapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: sent_req_adapter.ViewHolder, position: Int) {
